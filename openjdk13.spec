...
# Source0-md5:	0140f83eb9c664e47468566d807daf2f
...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk13-jdk < 13.0.14-3
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk13-jdk-base < 13.0.14-3
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk13-jre < 13.0.14-3
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk13-jre-base < 13.0.14-3
...
Obsoletes:	openjdk13-jre-base-X11 < 13.0.14-3
...
Obsoletes:	openjdk13-jre-base-freetype < 13.0.14-3
...
Obsoletes:	jar
Obsoletes:	openjdk13-jar < 13.0.14-3
